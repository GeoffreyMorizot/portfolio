...
<article class="education__wrapper">
    ...
    <div class="education__bottom">
        ...
        <p>
            <time :datetime="education.startDate">{{ education.startDate | formatDate() | changeSeparator() }}</time>
            <span>-</span>
            <time :datetime="education.endDate">{{ education.endDate | formatDate() | changeSeparator() }}</time>
        </p>
    </div>
</article>
